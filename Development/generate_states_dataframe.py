...
def generate_states_df(states_matrix_name='states',initial_failure_table_name='initial_failures', clusters_matrix_name='cluster_branch_118', number_of_lines=186, use_test_cluster=False, output_df_name = "states_dataframe", use_simplified_df = False, states_matrix_folder = '', save_as_csv = False):
    ...
    for simulation in reversed(initial_failures_to_pop):
        ...
        initial_failures.pop(simulation)
