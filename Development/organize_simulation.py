...
def organize_simulation(simulation_name, debug = False):
    ...
    if not os.path.exists('Simulation_Data' + os.sep +  simulation_name + os.sep + 'tops'):
        os.makedirs('Simulation_Data' + os.sep +  simulation_name + os.sep + 'tops')
    
    ##Initial File Copying##
    #move the states file named [simulation_name]_sm to the Simulation_Data/[simulation_name] folder
    os.rename(simulation_name + '_sm.mat', 'Simulation_Data' + os.sep +  simulation_name + os.sep + simulation_name + '_sm.mat')
    #move the initial_failures file named [simulation_name]_if to the Simulation_Data/[simulation_name] folder
    os.rename(simulation_name + '_if.mat', 'Simulation_Data' + os.sep +  simulation_name + os.sep + simulation_name + '_if.mat')
    #move the dataframe file named [simulation_name]_df to the Simulation_Data/[simulation_name] folder
    os.rename(simulation_name + '_df.csv', 'Simulation_Data' + os.sep +  simulation_name + os.sep + simulation_name + '_df.csv')
    #move the pstop file named [simulation_name]_pstop to the Simulation_Data/[simulation_name] folder
    os.rename(simulation_name + '_pstop.csv', 'Simulation_Data' +os.sep + simulation_name + os.sep + simulation_name + '_pstop.csv')
    #move the simulation log file named [simulation_name]_log to the Simulation_Data/[simulation_name] folder
    #os.rename(simulation_name + '_log', 'Simulation_Data' + os.sep +  simulation_name + os.sep + simulation_name + '_log')
    ...
    for file in os.listdir('folder_mpc'):
        ...
        os.rename('folder_mpc' + os.sep + file, 'Simulation_Data' + os.sep +  simulation_name + os.sep + 'tops' + os.sep + simulation_name + f"_n{iteration_number}_top.mat")
