...
for k=10:10
    ...
    [States, Initial_Failure_Table, mpc_cell]=S_FindingStateSpace_ANN_dataset_function(topology, iterations, initialFailures, loadGenerationRatio, loadShedConstant, capacityEstimationError, 10);
...
for k = 1:10
    mpc = mpc_cell{k};
    save(sprintf("mpc_%s_%d", topology, k), 'mpc') 
end
